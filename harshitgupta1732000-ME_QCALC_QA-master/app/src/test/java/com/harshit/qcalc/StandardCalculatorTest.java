...
public class StandardCalculatorTest {
   ...
   @Test
   @DisplayName("Test Multiplication for Two Doubles")
    void testMultiplicationForDoubles(){
   ...
   void testDivisionForDoubles(){
      standardCalculator.divide(1, 2);
      double actualResult= standardCalculator.getResult();
   ...
   @Test
   @DisplayName("Test Multiplication for Two Integers")
    void testMultiplicationForIntegers(){
   ...
   @Test
   @DisplayName("Test Division for Two Integers")
   void testDivisionForIntegers(){
      standardCalculator.divide(10, 20);
      double actualResult= standardCalculator.getResult();
      Assertions.assertEquals(0.5, actualResult);
   }
